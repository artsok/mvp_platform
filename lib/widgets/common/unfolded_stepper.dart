...
class UnfoldedStep {
  UnfoldedStep({
    ...
    this.subtitle,
    this.content,
    this.state = UnfoldedStepState.indexed,
    this.isActive = false,
  })  : assert(title != null),
        assert(state != null);
...
class UnfoldedStepper extends StatefulWidget {
  ...
  @override
  _UnfoldedStepperState createState() => _UnfoldedStepperState();
}

class _UnfoldedStepperState extends State<UnfoldedStepper>
    with TickerProviderStateMixin {
  List<GlobalKey> _keys;
  final Map<int, UnfoldedStepState> _oldStates = <int, UnfoldedStepState>{};
  ...
  @override
  void didUpdateWidget(UnfoldedStepper oldWidget) {
  ...
  bool _isCurrent(int index) => true;
      ...
      child: AnimatedContainer(
        ...
        child: Center(
          child: _buildCircleChild(index,
              oldState && widget.steps[index].state == UnfoldedStepState.error),
        ),
      ),
    );
  }
          ...
          child: CustomPaint(
            ...
            child: Align(
              ...
              child: _buildCircleChild(
                  index,
                  oldState &&
                      widget.steps[index].state != UnfoldedStepState.error),
            ),
          ),
        ),
      ),
  ...
  Widget _buildIcon(int index) {
    if (widget.steps[index].state != _oldStates[index]) {
      return AnimatedCrossFade(
        ...
        crossFadeState: widget.steps[index].state == UnfoldedStepState.error
            ? CrossFadeState.showSecond
            : CrossFadeState.showFirst,
        duration: kThemeAnimationDuration,
      );
    } else {
      if (widget.steps[index].state != UnfoldedStepState.error)
            ...
            children: <Widget>[
              InkWell(
                onTap: widget.steps[i].state != UnfoldedStepState.disabled
                    ...
                    : null,
                canRequestFocus:
                    widget.steps[i].state != UnfoldedStepState.disabled,
